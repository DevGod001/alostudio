...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-black/5">
      ...
      {/* Booking Completion Dialog - DEBUG: Always show */}
      <Dialog open={true} onOpenChange={setShowCompletionDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Complete Booking (DEBUG)</DialogTitle>
            <DialogDescription>
              This is a test - completion dialog should be visible
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="text-center p-4">
              <p>If you can see this, the dialog component works!</p>
              <Button onClick={() => setShowCompletionDialog(false)} className="mt-2">
                Close Dialog
              </Button>
            </div>
          </div>
